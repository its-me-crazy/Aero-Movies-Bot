        ...
        try: 
            ...
            if refData and refData.split("-", 1)[0] == "Jisshu":
                ...
                if AUTH_CHANNEL and await is_req_subscribed(client, message):
                        ...
                        reply_markup = InlineKeyboardMarkup(buttons)
                        m=await message.reply_sticker("CAACAgUAAxkBAAIQ32qJviaKgiT5yQ3h4SQNj7R5ebz7AAKSJAACnR9RVGNcSBVd4vE0PQQ") 
...
async def save_tutorial(client, message):
    ...
    try:
        ...
        return await message.reply_text("<b>Command Incomplete!!\n\nuse like this -</b>\n\n<code>/set_caption https://t.me/Mr_Mohammed_29</code>")    
...
async def refer(bot, message):
    ...
    m=await message.reply_sticker("CAACAgUAAxkBAAIQ3GqJsiJiVQM9b-JUqATb0OyD7RNvAAKHJAACwtRoVXT6sOXwNv75PQQ")      
    await m.delete()
    reply_markup = InlineKeyboardMarkup(btn)
    await message.reply_photo(
